...
| `rules.xlsx` → `telegram_routes` (optional) | same workbook | Phase 2 shadow; Phase 3A: `platform_hourly_report` when `TELEGRAM_ROUTES_FROM_RULES_V2=1` | OPTIONAL | CONFIRMED |
