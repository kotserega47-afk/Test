...
RULE_ORPHAN_JOB: Final[str] = "RULE_ORPHAN_JOB"
RULE_EMPTY_JOBS: Final[str] = "RULE_EMPTY_JOBS"
RULE_UNSUPPORTED_JOB_PARAM: Final[str] = "RULE_UNSUPPORTED_JOB_PARAM"
RULE_INVALID_THRESHOLD: Final[str] = "RULE_INVALID_THRESHOLD"
...
DEFAULT_SEVERITY: Final[Mapping[str, ValidationSeverity]] = {
    ...
    RULE_ORPHAN_JOB: _E,
    RULE_EMPTY_JOBS: _E,
    RULE_UNSUPPORTED_JOB_PARAM: _E,
    RULE_INVALID_THRESHOLD: _E,
