...
async def cmd_registry_replay(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    if not await _guard_or_deny(update, "registry_replay"):
        return
    ...
    try:
        ...
        log.exception("cmd_registry_replay failed")
